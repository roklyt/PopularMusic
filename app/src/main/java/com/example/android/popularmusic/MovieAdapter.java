...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieAdapterViewHolder> {
    ...
    public class MovieAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MovieAdapterViewHolder(View view) {
            super(view);
            MovieImageView = view.findViewById(R.id.poster_image);
    ...
    public void onBindViewHolder(MovieAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        Log.e("MovieAdapter", movies.getPosterPath());

        Uri builtUri = Uri.parse(NetworkUtils.BASE_POSTER_URL).buildUpon()
                .appendPath(movies.getPosterPath())
                .build();
